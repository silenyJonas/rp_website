...
//     const target_user_id = item.target_user_id
...
//     if (!this.selectedItemForEdit || !this.selectedItemForEdit.id) {
//       console.error('ID uživatele není k dispozici.');
//       this.handleResetPasswordFormClosed();
//       return;
//     }

//     // Extrahování pouze potřebných dat pro změnu hesla
//     const passwordData = {
...
//     this.updatePassword(this.selectedItemForEdit.id, passwordData)
//       .pipe(
//         finalize(() => {
//           this.handleResetPasswordFormClosed();
//         })
