...
//         $fullName = $request->input('full_name'); // NOVÉ
//         $personalIdNum = $request->input('personal_id_num'); // NOVÉ
...
//         // Rozšířené ukládání o nové sloupce
...
//         // Pole, která se mají aktualizovat, pokud jsou v requestu
//         $fields = [
//             'user_email', 'full_name', 'birth_date', 'personal_id_num', 
...
//             // BEZPEČNOSTNÍ FILTR: Odstraníme hesla z dat, která jdou do logu, 
//             // ale ponecháme ostatní užitečné info (jméno, provize, atd.)
