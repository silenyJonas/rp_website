    ...
    public function rules(): array
{
    return [
        ...
        // Přidáno nullable, aby prázdná pole nezpůsobila chybu validace
        ...
        // Tady pozor: Pokud je v DB NOT NULL, musí být nullable ve validaci 
        // a v prepareForValidation zajistíme default hodnotu (false/0).
...
{
    $this->merge([
        // Pokud pole chybí nebo je prázdné, dosadíme false (0 pro DB)
